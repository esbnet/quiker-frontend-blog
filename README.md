...
Esta aplicação se propõe a ser um site de compartilhamento de notícias. Nela, qualquer pessoa poderá se cadastrar e criar artigos que ficarão disponíveis ao público da internet.

Para utilizá-la, basta realizar um registro prévio e estará hapto a realizar postagens, comentários em postagens de terceiros e dar manutenção em seus próprios comentários, como excluir, por exemplo.

...
const navigationMenuTriggerStyle = cva(
	"inline-flex justify-center items-center bg-white data-[state=open]:bg-slate-100/50 hover:bg-slate-100 dark:hover:bg-slate-800 focus:bg-slate-100 dark:focus:bg-slate-800 data-[active]:bg-slate-100/50 dark:data-[active]:bg-slate-800/50 dark:bg-slate-950 dark:data-[state=open]:bg-slate-800/50 disabled:opacity-50 px-4 py-2 rounded-md w-max h-10 font-medium text-sm hover:text-slate-900 dark:hover:text-slate-50 focus:text-slate-900 dark:focus:text-slate-50 transition-colors disabled:pointer-events-none group focus:outline-none",
);
